...
```{r echo=FALSE, warning=FALSE, message=FALSE,fig.width=6,fig.asp=1.1}
...
df_probs %>%
  ...
  labs(title=toupper(paste0("Eurovision Probability of Winning ",year)), 
       ...
       caption="Data from oddschecker.co.uk",
       x="",y="") +
...
```{r echo=FALSE, warning=FALSE, message=FALSE,out.width="350px", fig.width=6,fig.asp=1.1}
library(tidyverse)
library(knitr)
load("eurovision-bookmakers.RData")
